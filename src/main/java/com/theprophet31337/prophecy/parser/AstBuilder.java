...
import com.theprophet31337.prophecy.parser.antlr4.ProphecyBaseListener;
import com.theprophet31337.prophecy.parser.antlr4.ProphecyParser.AddExprContext;
import com.theprophet31337.prophecy.parser.antlr4.ProphecyParser.ArrayAccessSelExprContext;
import com.theprophet31337.prophecy.parser.antlr4.ProphecyParser.ArrayVardeclContext;
import com.theprophet31337.prophecy.parser.antlr4.ProphecyParser.AssignmentExprContext;
import com.theprophet31337.prophecy.parser.antlr4.ProphecyParser.AssignmentStmtContext;
import com.theprophet31337.prophecy.parser.antlr4.ProphecyParser.BitAndExprContext;
import com.theprophet31337.prophecy.parser.antlr4.ProphecyParser.BitOrExprContext;
import com.theprophet31337.prophecy.parser.antlr4.ProphecyParser.BitXorExprContext;
import com.theprophet31337.prophecy.parser.antlr4.ProphecyParser.BlockContext;
import com.theprophet31337.prophecy.parser.antlr4.ProphecyParser.CallContext;
import com.theprophet31337.prophecy.parser.antlr4.ProphecyParser.CallSelExprContext;
import com.theprophet31337.prophecy.parser.antlr4.ProphecyParser.CastExprContext;
import com.theprophet31337.prophecy.parser.antlr4.ProphecyParser.CharlitPrimaryContext;
import com.theprophet31337.prophecy.parser.antlr4.ProphecyParser.ClassdefContext;
import com.theprophet31337.prophecy.parser.antlr4.ProphecyParser.DefblockContext;
import com.theprophet31337.prophecy.parser.antlr4.ProphecyParser.DefstatContext;
import com.theprophet31337.prophecy.parser.antlr4.ProphecyParser.EqualityExprContext;
import com.theprophet31337.prophecy.parser.antlr4.ProphecyParser.ExprlistContext;
import com.theprophet31337.prophecy.parser.antlr4.ProphecyParser.FalsePrimaryContext;
import com.theprophet31337.prophecy.parser.antlr4.ProphecyParser.FielddefContext;
import com.theprophet31337.prophecy.parser.antlr4.ProphecyParser.FileContext;
import com.theprophet31337.prophecy.parser.antlr4.ProphecyParser.FloatlitPrimaryContext;
import com.theprophet31337.prophecy.parser.antlr4.ProphecyParser.IdPrimaryContext;
import com.theprophet31337.prophecy.parser.antlr4.ProphecyParser.IfStmtContext;
import com.theprophet31337.prophecy.parser.antlr4.ProphecyParser.IntlitPrimaryContext;
import com.theprophet31337.prophecy.parser.antlr4.ProphecyParser.LogicAndExprContext;
import com.theprophet31337.prophecy.parser.antlr4.ProphecyParser.LogicOrExprContext;
import com.theprophet31337.prophecy.parser.antlr4.ProphecyParser.MemberAccessSelExprContext;
import com.theprophet31337.prophecy.parser.antlr4.ProphecyParser.MethoddefContext;
import com.theprophet31337.prophecy.parser.antlr4.ProphecyParser.MulExprContext;
import com.theprophet31337.prophecy.parser.antlr4.ProphecyParser.ParamContext;
import com.theprophet31337.prophecy.parser.antlr4.ProphecyParser.ParamlistContext;
import com.theprophet31337.prophecy.parser.antlr4.ProphecyParser.PostfixExprContext;
import com.theprophet31337.prophecy.parser.antlr4.ProphecyParser.PrefixExprContext;
import com.theprophet31337.prophecy.parser.antlr4.ProphecyParser.RegVardeclContext;
import com.theprophet31337.prophecy.parser.antlr4.ProphecyParser.RelationExprContext;
import com.theprophet31337.prophecy.parser.antlr4.ProphecyParser.ReturnStmtContext;
import com.theprophet31337.prophecy.parser.antlr4.ProphecyParser.ShiftExprContext;
import com.theprophet31337.prophecy.parser.antlr4.ProphecyParser.StringlitPrimaryContext;
import com.theprophet31337.prophecy.parser.antlr4.ProphecyParser.ThisPrimaryContext;
import com.theprophet31337.prophecy.parser.antlr4.ProphecyParser.TruePrimaryContext;
import com.theprophet31337.prophecy.parser.antlr4.ProphecyParser.WhileStmtContext;
