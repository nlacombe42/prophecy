...
import net.nlacombe.prophecy.analyser.symboltable.SymbolTableBuilder;
import net.nlacombe.prophecy.analyser.symboltable.scope.GlobalScope;
import net.nlacombe.prophecy.analyser.type.TypeAnalyser;
import net.nlacombe.prophecy.ast.ProphecyAstNode;
import net.nlacombe.prophecy.generator.ProphecyGenerator;
import net.nlacombe.prophecy.generator.ProphecyGeneratorTarget;
import net.nlacombe.prophecy.parser.ProphecyAstBuilder;
import net.nlacombe.prophecy.parser.ProphecyParserException;
