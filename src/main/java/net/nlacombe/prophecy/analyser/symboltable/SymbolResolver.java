...
import net.nlacombe.prophecy.analyser.symboltable.symbol.ArraySymbol;
...
import net.nlacombe.prophecy.analyser.symboltable.symbol.VariableSymbol;
import net.nlacombe.prophecy.ast.ProphecyAstBaseListener;
import net.nlacombe.prophecy.ast.ProphecyAstNode;
import net.nlacombe.prophecy.ast.ProphecyAstNodeType;
import net.nlacombe.prophecy.ast.ProphecyAstUtil;
import net.nlacombe.prophecy.ast.nodewrapper.AstCast;
import net.nlacombe.prophecy.ast.nodewrapper.AstClassDef;
import net.nlacombe.prophecy.ast.nodewrapper.AstFieldDef;
import net.nlacombe.prophecy.ast.nodewrapper.AstMember;
import net.nlacombe.prophecy.ast.nodewrapper.AstMethodDef;
import net.nlacombe.prophecy.ast.nodewrapper.AstParam;
import net.nlacombe.prophecy.ast.nodewrapper.AstVarDecl;
