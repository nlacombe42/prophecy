...
import net.nlacombe.prophecy.ast.nodewrapper.AstCall;
...
import net.nlacombe.prophecy.exception.ProphecyAmbiguousCallException;
import net.nlacombe.prophecy.exception.ProphecyMethodNotFoundException;
