...
import net.nlacombe.prophecy.ast.ProphecyAstBaseVisitor;
import net.nlacombe.prophecy.ast.ProphecyAstNode;
import net.nlacombe.prophecy.ast.ProphecyAstVisitorDispatcher;
import net.nlacombe.prophecy.ast.nodewrapper.AstCall;
import net.nlacombe.prophecy.ast.nodewrapper.AstVarDecl;
import net.nlacombe.prophecy.generator.bean.Argument;
