...
public class ProphecyParser extends Parser {
	...
	public static final String[] tokenNames = {
		...
		"'='", "'}'", "'^'", "'<='", "'[]'", "'&'", "'('", "'*'", "','", "'.'", 
		"'['", "'>='", "'--'", "'++'", "'<'", "'=='", "'|'", "']'", "'~'", "'>'", 
		"'!'", "')'", "'+'", "'-'", "'class'", "'extends'", "'this'", "'static'", 
		"'if'", "'while'", "'else'", "'return'", "'true'", "'false'", "'float'", 
		"'int'", "'char'", "'bool'", "'void'", "ID", "STRINGLIT", "INTLIT", "FLOATLIT", 
	...
	@Override
	public String getGrammarFileName() { return "Prophecy.g4"; }
	...
	public static class FileContext extends ParserRuleContext {
		public TerminalNode EOF() { return getToken(ProphecyParser.EOF, 0); }
	...
	public static class ClassdefContext extends ParserRuleContext {
		...
		public List<TerminalNode> ID() { return getTokens(ProphecyParser.ID); }
		...
		public TerminalNode CLASS() { return getToken(ProphecyParser.CLASS, 0); }
		public TerminalNode EXTENDS() { return getToken(ProphecyParser.EXTENDS, 0); }
	...
	public final ClassdefContext classdef() throws RecognitionException {
		...
		try {
			...
			setState(44); ((ClassdefContext)_localctx).name = match(ID);
			setState(47);
			_la = _input.LA(1);
			if (_la==EXTENDS) {
				{
				setState(45); match(EXTENDS);
				setState(46); ((ClassdefContext)_localctx).superClassName = match(ID);
				}
			}

			setState(49); defblock();
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public final DefstatContext defstat() throws RecognitionException {
		...
		try {
			...
			case 1:
				{
				setState(62); fielddef();
				}
				break;

			case 2:
				{
				setState(63); methoddef();
				}
				break;
			}
			}
	...
	public static class ModifierContext extends ParserRuleContext {
		...
		public TerminalNode STATIC() { return getToken(ProphecyParser.STATIC, 0); }
	...
	public final ModifierContext modifier() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(66); ((ModifierContext)_localctx).static_ = match(STATIC);
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public static class FielddefContext extends ParserRuleContext {
		public Token name;
		public TerminalNode ID() { return getToken(ProphecyParser.ID, 0); }
	...
	public final FielddefContext fielddef() throws RecognitionException {
		...
		try {
			...
			{
			setState(68); type();
			setState(69); ((FielddefContext)_localctx).name = match(ID);
			setState(70); match(4);
			}
		}
		catch (RecognitionException re) {
	...
	public static class MethoddefContext extends ParserRuleContext {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof ProphecyVisitor ) return ((ProphecyVisitor<? extends T>)visitor).visitMethoddef(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public static class ParamlistContext extends ParserRuleContext {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof ProphecyVisitor ) return ((ProphecyVisitor<? extends T>)visitor).visitParamlist(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public final ParamContext param() throws RecognitionException {
		...
		try {
			...
			{
			setState(91); type();
			setState(92); ((ParamContext)_localctx).name = match(ID);
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public final BlockContext block() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			while ((((_la) & ~0x3f) == 0 && ((1L << _la) & ((1L << 5) | (1L << 15) | (1L << THIS) | (1L << IF) | (1L << WHILE) | (1L << RETURN) | (1L << TRUE) | (1L << FALSE) | (1L << FLOAT) | (1L << INT) | (1L << CHAR) | (1L << BOOL) | (1L << VOID) | (1L << ID) | (1L << STRINGLIT) | (1L << INTLIT) | (1L << FLOATLIT) | (1L << CHARLIT))) != 0)) {
				{
				{
				setState(95); stmt();
				}
	...
	public static class WhileStmtContext extends StmtContext {
		...
		public TerminalNode WHILE() { return getToken(ProphecyParser.WHILE, 0); }
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof ProphecyVisitor ) return ((ProphecyVisitor<? extends T>)visitor).visitWhileStmt(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public static class IfStmtContext extends StmtContext {
		...
		public TerminalNode ELSE() { return getToken(ProphecyParser.ELSE, 0); }
		public TerminalNode IF() { return getToken(ProphecyParser.IF, 0); }
		public ExprContext expr() {
			return getRuleContext(ExprContext.class,0);
		}
		public StmtContext stmt(int i) {
	...
	public static class BlockStmtContext extends StmtContext {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof ProphecyVisitor ) return ((ProphecyVisitor<? extends T>)visitor).visitBlockStmt(this);
			else return visitor.visitChildren(this);
		}
	}
	public static class ReturnStmtContext extends StmtContext {
		public ExprContext value;
		public TerminalNode RETURN() { return getToken(ProphecyParser.RETURN, 0); }
		public ExprContext expr() {
			return getRuleContext(ExprContext.class,0);
		}
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof ProphecyVisitor ) return ((ProphecyVisitor<? extends T>)visitor).visitReturnStmt(this);
			else return visitor.visitChildren(this);
		}
	}
	public static class AssignmentStmtContext extends StmtContext {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof ProphecyVisitor ) return ((ProphecyVisitor<? extends T>)visitor).visitAssignmentStmt(this);
			else return visitor.visitChildren(this);
		}
	}
	public static class VarDeclStmtContext extends StmtContext {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof ProphecyVisitor ) return ((ProphecyVisitor<? extends T>)visitor).visitVarDeclStmt(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public final StmtContext stmt() throws RecognitionException {
		...
		try {
			...
			case 3:
				...
				setState(107); ((IfStmtContext)_localctx).cond = expr(0);
				setState(108); match(30);
				setState(109); stmt();
				setState(112);
			...
			case 5:
				...
				setState(122);
				_la = _input.LA(1);
				if ((((_la) & ~0x3f) == 0 && ((1L << _la) & ((1L << 15) | (1L << 21) | (1L << 22) | (1L << 27) | (1L << 29) | (1L << 31) | (1L << 32) | (1L << THIS) | (1L << TRUE) | (1L << FALSE) | (1L << ID) | (1L << STRINGLIT) | (1L << INTLIT) | (1L << FLOATLIT) | (1L << CHARLIT))) != 0)) {
					{
					setState(121); ((ReturnStmtContext)_localctx).value = expr(0);
					}
				}
			...
			case 6:
				...
				setState(127); ((AssignmentStmtContext)_localctx).rhs = expr(0);
	...
	public static class ArrayVardeclContext extends VardeclContext {
		...
		public ArrayVardeclContext(VardeclContext ctx) { copyFrom(ctx); }
		@Override
		public void enterRule(ParseTreeListener listener) {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof ProphecyVisitor ) return ((ProphecyVisitor<? extends T>)visitor).visitArrayVardecl(this);
			else return visitor.visitChildren(this);
		}
	}
	public static class RegVardeclContext extends VardeclContext {
		...
		public RegVardeclContext(VardeclContext ctx) { copyFrom(ctx); }
		@Override
		public void enterRule(ParseTreeListener listener) {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof ProphecyVisitor ) return ((ProphecyVisitor<? extends T>)visitor).visitRegVardecl(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public final VardeclContext vardecl() throws RecognitionException {
		...
		try {
			...
			case 1:
				...
				{
				setState(137); type();
				setState(138); ((RegVardeclContext)_localctx).name = match(ID);
				setState(141);
				_la = _input.LA(1);
				if (_la==9) {
					{
					setState(139); match(9);
					setState(140); ((RegVardeclContext)_localctx).init = expr(0);
					}
				}
			...
			case 2:
				...
				setState(147); ((ArrayVardeclContext)_localctx).name = match(ID);
				setState(150);
				_la = _input.LA(1);
				if (_la==9) {
					{
					setState(148); match(9);
					setState(149); ((ArrayVardeclContext)_localctx).init = expr(0);
					}
				}
	...
	public static class AssignmentExprContext extends ExprContext {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof ProphecyVisitor ) return ((ProphecyVisitor<? extends T>)visitor).visitAssignmentExpr(this);
			else return visitor.visitChildren(this);
		}
	}
	public static class LogicOrExprContext extends ExprContext {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof ProphecyVisitor ) return ((ProphecyVisitor<? extends T>)visitor).visitLogicOrExpr(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public static class SelectorExprContext extends ExprContext {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof ProphecyVisitor ) return ((ProphecyVisitor<? extends T>)visitor).visitSelectorExpr(this);
			else return visitor.visitChildren(this);
		}
	}
	public static class BitXorExprContext extends ExprContext {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof ProphecyVisitor ) return ((ProphecyVisitor<? extends T>)visitor).visitBitXorExpr(this);
			else return visitor.visitChildren(this);
		}
	}
	public static class ShiftExprContext extends ExprContext {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof ProphecyVisitor ) return ((ProphecyVisitor<? extends T>)visitor).visitShiftExpr(this);
			else return visitor.visitChildren(this);
		}
	}
	public static class PrefixExprContext extends ExprContext {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof ProphecyVisitor ) return ((ProphecyVisitor<? extends T>)visitor).visitPrefixExpr(this);
			else return visitor.visitChildren(this);
		}
	}
	public static class BitOrExprContext extends ExprContext {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof ProphecyVisitor ) return ((ProphecyVisitor<? extends T>)visitor).visitBitOrExpr(this);
			else return visitor.visitChildren(this);
		}
	}
	public static class LogicAndExprContext extends ExprContext {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof ProphecyVisitor ) return ((ProphecyVisitor<? extends T>)visitor).visitLogicAndExpr(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public static class PostfixExprContext extends ExprContext {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof ProphecyVisitor ) return ((ProphecyVisitor<? extends T>)visitor).visitPostfixExpr(this);
			else return visitor.visitChildren(this);
		}
	}
	public static class BitAndExprContext extends ExprContext {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof ProphecyVisitor ) return ((ProphecyVisitor<? extends T>)visitor).visitBitAndExpr(this);
			else return visitor.visitChildren(this);
		}
	}
	public static class EqualityExprContext extends ExprContext {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof ProphecyVisitor ) return ((ProphecyVisitor<? extends T>)visitor).visitEqualityExpr(this);
			else return visitor.visitChildren(this);
		}
	}
	public static class RelationExprContext extends ExprContext {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof ProphecyVisitor ) return ((ProphecyVisitor<? extends T>)visitor).visitRelationExpr(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	private ExprContext expr(int _p) throws RecognitionException {
		...
		try {
			...
			case 3:
				...
				_la = _input.LA(1);
				if ( !((((_la) & ~0x3f) == 0 && ((1L << _la) & ((1L << 21) | (1L << 22) | (1L << 27) | (1L << 29) | (1L << 31) | (1L << 32))) != 0)) ) {
			...
			while ( _alt!=2 && _alt!=ATN.INVALID_ALT_NUMBER ) {
				if ( _alt==1 ) {
					...
					case 1:
						...
						setState(184); ((LogicOrExprContext)_localctx).right = expr(15);
						}
						break;
					...
					case 2:
						...
						setState(187); ((LogicAndExprContext)_localctx).right = expr(14);
						}
						break;
					...
					case 3:
						...
						setState(189); match(25);
						setState(190); ((BitOrExprContext)_localctx).right = expr(13);
						}
						break;
					...
					case 4:
						...
						setState(193); ((BitXorExprContext)_localctx).right = expr(12);
						}
						break;
					...
					case 5:
						...
						setState(196); ((BitAndExprContext)_localctx).right = expr(11);
						}
						break;
					...
					case 6:
						...
						consume();
						setState(199); ((EqualityExprContext)_localctx).right = expr(10);
						}
						break;
					...
					case 7:
						...
						_la = _input.LA(1);
						if ( !((((_la) & ~0x3f) == 0 && ((1L << _la) & ((1L << 12) | (1L << 20) | (1L << 23) | (1L << 28))) != 0)) ) {
							((RelationExprContext)_localctx).operator = (Token)_errHandler.recoverInline(this);
						}
						consume();
						setState(202); ((RelationExprContext)_localctx).right = expr(9);
						}
						break;
					...
					case 8:
						...
						consume();
						setState(205); ((ShiftExprContext)_localctx).right = expr(8);
						}
						break;
					...
					case 9:
						...
						consume();
						setState(208); ((MulExprContext)_localctx).right = expr(7);
						}
						break;
					...
					case 10:
						...
						consume();
						setState(211); ((AddExprContext)_localctx).right = expr(6);
						}
						break;
					}
					} 
	...
	public static class SelexprContext extends ParserRuleContext {
		...
		@Override public int getRuleIndex() { return RULE_selexpr; }
	...
	public static class MemberAccessSelExprContext extends SelexprContext {
		...
		public MemberAccessSelExprContext(SelexprContext ctx) { copyFrom(ctx); }
		@Override
		public void enterRule(ParseTreeListener listener) {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof ProphecyVisitor ) return ((ProphecyVisitor<? extends T>)visitor).visitMemberAccessSelExpr(this);
			else return visitor.visitChildren(this);
		}
	}
	public static class ArrayAccessSelExprContext extends SelexprContext {
		...
		public ArrayAccessSelExprContext(SelexprContext ctx) { copyFrom(ctx); }
		@Override
		public void enterRule(ParseTreeListener listener) {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof ProphecyVisitor ) return ((ProphecyVisitor<? extends T>)visitor).visitArrayAccessSelExpr(this);
			else return visitor.visitChildren(this);
		}
	}
	public static class CallSelExprContext extends SelexprContext {
		...
		public CallSelExprContext(SelexprContext ctx) { copyFrom(ctx); }
		@Override
		public void enterRule(ParseTreeListener listener) {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof ProphecyVisitor ) return ((ProphecyVisitor<? extends T>)visitor).visitCallSelExpr(this);
			else return visitor.visitChildren(this);
		}
	}
	public static class PrimarySelExprContext extends SelexprContext {
		...
		public PrimarySelExprContext(SelexprContext ctx) { copyFrom(ctx); }
		@Override
		public void enterRule(ParseTreeListener listener) {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof ProphecyVisitor ) return ((ProphecyVisitor<? extends T>)visitor).visitPrimarySelExpr(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public static class ThisPrimaryContext extends PrimaryContext {
		public TerminalNode THIS() { return getToken(ProphecyParser.THIS, 0); }
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof ProphecyVisitor ) return ((ProphecyVisitor<? extends T>)visitor).visitThisPrimary(this);
			else return visitor.visitChildren(this);
		}
	}
	public static class CharlitPrimaryContext extends PrimaryContext {
		public TerminalNode CHARLIT() { return getToken(ProphecyParser.CHARLIT, 0); }
		public CharlitPrimaryContext(PrimaryContext ctx) { copyFrom(ctx); }
		@Override
		public void enterRule(ParseTreeListener listener) {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof ProphecyVisitor ) return ((ProphecyVisitor<? extends T>)visitor).visitCharlitPrimary(this);
			else return visitor.visitChildren(this);
		}
	}
	public static class IntlitPrimaryContext extends PrimaryContext {
		public TerminalNode INTLIT() { return getToken(ProphecyParser.INTLIT, 0); }
		public IntlitPrimaryContext(PrimaryContext ctx) { copyFrom(ctx); }
		@Override
		public void enterRule(ParseTreeListener listener) {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof ProphecyVisitor ) return ((ProphecyVisitor<? extends T>)visitor).visitIntlitPrimary(this);
			else return visitor.visitChildren(this);
		}
	}
	public static class StringlitPrimaryContext extends PrimaryContext {
		public TerminalNode STRINGLIT() { return getToken(ProphecyParser.STRINGLIT, 0); }
		public StringlitPrimaryContext(PrimaryContext ctx) { copyFrom(ctx); }
		@Override
		public void enterRule(ParseTreeListener listener) {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof ProphecyVisitor ) return ((ProphecyVisitor<? extends T>)visitor).visitStringlitPrimary(this);
			else return visitor.visitChildren(this);
		}
	}
	public static class IdPrimaryContext extends PrimaryContext {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof ProphecyVisitor ) return ((ProphecyVisitor<? extends T>)visitor).visitIdPrimary(this);
			else return visitor.visitChildren(this);
		}
	}
	public static class FalsePrimaryContext extends PrimaryContext {
		public TerminalNode FALSE() { return getToken(ProphecyParser.FALSE, 0); }
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof ProphecyVisitor ) return ((ProphecyVisitor<? extends T>)visitor).visitFalsePrimary(this);
			else return visitor.visitChildren(this);
		}
	}
	public static class BracketPrimaryContext extends PrimaryContext {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof ProphecyVisitor ) return ((ProphecyVisitor<? extends T>)visitor).visitBracketPrimary(this);
			else return visitor.visitChildren(this);
		}
	}
	public static class TruePrimaryContext extends PrimaryContext {
		public TerminalNode TRUE() { return getToken(ProphecyParser.TRUE, 0); }
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof ProphecyVisitor ) return ((ProphecyVisitor<? extends T>)visitor).visitTruePrimary(this);
			else return visitor.visitChildren(this);
		}
	}
	public static class FloatlitPrimaryContext extends PrimaryContext {
		public TerminalNode FLOATLIT() { return getToken(ProphecyParser.FLOATLIT, 0); }
		public FloatlitPrimaryContext(PrimaryContext ctx) { copyFrom(ctx); }
		@Override
		public void enterRule(ParseTreeListener listener) {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof ProphecyVisitor ) return ((ProphecyVisitor<? extends T>)visitor).visitFloatlitPrimary(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public static class PrimitiveTypeContext extends ParserRuleContext {
		public TerminalNode BOOL() { return getToken(ProphecyParser.BOOL, 0); }
		public TerminalNode VOID() { return getToken(ProphecyParser.VOID, 0); }
		public TerminalNode CHAR() { return getToken(ProphecyParser.CHAR, 0); }
		public TerminalNode INT() { return getToken(ProphecyParser.INT, 0); }
		public TerminalNode FLOAT() { return getToken(ProphecyParser.FLOAT, 0); }
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof ProphecyVisitor ) return ((ProphecyVisitor<? extends T>)visitor).visitPrimitiveType(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public boolean sempred(RuleContext _localctx, int ruleIndex, int predIndex) {
		...
		case 15: return selexpr_sempred((SelexprContext)_localctx, predIndex);
		}
		return true;
	}
	...
	public static final String _serializedATN =
		...
		"\2\27\30\35\35\37\37!\"\3\2\27\30\4\2\4\4\32\32\6\2\16\16\26\26\31\31"+
		"\36\36\3\2\b\t\4\2\3\3\22\22\3\2!\"\3\2-\61\u0128\2*\3\2\2\2\4-\3\2\2"+
		"\2\6\65\3\2\2\2\b>\3\2\2\2\nD\3\2\2\2\fF\3\2\2\2\16K\3\2\2\2\20U\3\2\2"+
		"\2\22]\3\2\2\2\24`\3\2\2\2\26\u0087\3\2\2\2\30\u0089\3\2\2\2\32\u009c"+
		"\3\2\2\2\34\u009e\3\2\2\2\36\u00b6\3\2\2\2 \u00db\3\2\2\2\"\u00f1\3\2"+
		"\2\2$\u0104\3\2\2\2&\u0108\3\2\2\2(\u010a\3\2\2\2*+\5\4\3\2+,\7\2\2\3"+
		",\3\3\2\2\2-.\7#\2\2.\61\7\62\2\2/\60\7$\2\2\60\62\7\62\2\2\61/\3\2\2"+
		"\2\61\62\3\2\2\2\62\63\3\2\2\2\63\64\5\6\4\2\64\5\3\2\2\2\65\67\7\7\2"+
		"\2\668\5\b\5\2\67\66\3\2\2\289\3\2\2\29\67\3\2\2\29:\3\2\2\2:;\3\2\2\2"+
		";<\7\f\2\2<\7\3\2\2\2=?\5\n\6\2>=\3\2\2\2>?\3\2\2\2?B\3\2\2\2@C\5\f\7"+
		"\2AC\5\16\b\2B@\3\2\2\2BA\3\2\2\2C\t\3\2\2\2DE\7&\2\2E\13\3\2\2\2FG\5"+
		"&\24\2GH\7\62\2\2HI\7\6\2\2I\r\3\2\2\2JL\5&\24\2KJ\3\2\2\2KL\3\2\2\2L"+
		"M\3\2\2\2MN\7\62\2\2NP\7\21\2\2OQ\5\20\t\2PO\3\2\2\2PQ\3\2\2\2QR\3\2\2"+
		"\2RS\7 \2\2ST\5\24\13\2T\17\3\2\2\2UZ\5\22\n\2VW\7\23\2\2WY\5\22\n\2X"+
		"V\3\2\2\2Y\\\3\2\2\2ZX\3\2\2\2Z[\3\2\2\2[\21\3\2\2\2\\Z\3\2\2\2]^\5&\24"+
		"\2^_\7\62\2\2_\23\3\2\2\2`d\7\7\2\2ac\5\26\f\2ba\3\2\2\2cf\3\2\2\2db\3"+
		"\2\2\2de\3\2\2\2eg\3\2\2\2fd\3\2\2\2gh\7\f\2\2h\25\3\2\2\2i\u0088\5\24"+
		"\13\2j\u0088\5\32\16\2kl\7\'\2\2lm\7\21\2\2mn\5\36\20\2no\7 \2\2or\5\26"+
		"\f\2pq\7)\2\2qs\5\26\f\2rp\3\2\2\2rs\3\2\2\2s\u0088\3\2\2\2tu\7(\2\2u"+
		"v\7\21\2\2vw\5\36\20\2wx\7 \2\2xy\5\26\f\2y\u0088\3\2\2\2z|\7*\2\2{}\5"+
		"\36\20\2|{\3\2\2\2|}\3\2\2\2}~\3\2\2\2~\u0088\7\6\2\2\177\u0080\5\30\r"+
		"\2\u0080\u0081\7\13\2\2\u0081\u0082\5\36\20\2\u0082\u0083\7\6\2\2\u0083"+
		"\u0088\3\2\2\2\u0084\u0085\5\"\22\2\u0085\u0086\7\6\2\2\u0086\u0088\3"+
		"\2\2\2\u0087i\3\2\2\2\u0087j\3\2\2\2\u0087k\3\2\2\2\u0087t\3\2\2\2\u0087"+
		"z\3\2\2\2\u0087\177\3\2\2\2\u0087\u0084\3\2\2\2\u0088\27\3\2\2\2\u0089"+
		"\u008a\5 \21\2\u008a\31\3\2\2\2\u008b\u008c\5&\24\2\u008c\u008f\7\62\2"+
		"\2\u008d\u008e\7\13\2\2\u008e\u0090\5\36\20\2\u008f\u008d\3\2\2\2\u008f"+
		"\u0090\3\2\2\2\u0090\u0091\3\2\2\2\u0091\u0092\7\6\2\2\u0092\u009d\3\2"+
		"\2\2\u0093\u0094\5&\24\2\u0094\u0095\7\17\2\2\u0095\u0098\7\62\2\2\u0096"+
		...
		"\2\u00a5\u00a3\3\2\2\2\u00a6\u00a7\b\20\1\2\u00a7\u00a8\5\30\r\2\u00a8"+
		"\u00a9\7\13\2\2\u00a9\u00aa\5\36\20\21\u00aa\u00b7\3\2\2\2\u00ab\u00ac"+
		"\7\21\2\2\u00ac\u00ad\5&\24\2\u00ad\u00ae\7 \2\2\u00ae\u00af\5\36\20\6"+
		"\u00af\u00b7\3\2\2\2\u00b0\u00b1\t\2\2\2\u00b1\u00b7\5\36\20\5\u00b2\u00b3"+
		"\5 \21\2\u00b3\u00b4\t\3\2\2\u00b4\u00b7\3\2\2\2\u00b5\u00b7\5 \21\2\u00b6"+
		"\u00a6\3\2\2\2\u00b6\u00ab\3\2\2\2\u00b6\u00b0\3\2\2\2\u00b6\u00b2\3\2"+
		"\2\2\u00b6\u00b5\3\2\2\2\u00b7\u00d8\3\2\2\2\u00b8\u00b9\f\20\2\2\u00b9"+
		"\u00ba\7\5\2\2\u00ba\u00d7\5\36\20\21\u00bb\u00bc\f\17\2\2\u00bc\u00bd"+
		"\7\n\2\2\u00bd\u00d7\5\36\20\20\u00be\u00bf\f\16\2\2\u00bf\u00c0\7\33"+
		"\2\2\u00c0\u00d7\5\36\20\17\u00c1\u00c2\f\r\2\2\u00c2\u00c3\7\r\2\2\u00c3"+
		"\u00d7\5\36\20\16\u00c4\u00c5\f\f\2\2\u00c5\u00c6\7\20\2\2\u00c6\u00d7"+
		"\5\36\20\r\u00c7\u00c8\f\13\2\2\u00c8\u00c9\t\4\2\2\u00c9\u00d7\5\36\20"+
		"\f\u00ca\u00cb\f\n\2\2\u00cb\u00cc\t\5\2\2\u00cc\u00d7\5\36\20\13\u00cd"+
		"\u00ce\f\t\2\2\u00ce\u00cf\t\6\2\2\u00cf\u00d7\5\36\20\n\u00d0\u00d1\f"+
		"\b\2\2\u00d1\u00d2\t\7\2\2\u00d2\u00d7\5\36\20\t\u00d3\u00d4\f\7\2\2\u00d4"+
		"\u00d5\t\b\2\2\u00d5\u00d7\5\36\20\b\u00d6\u00b8\3\2\2\2\u00d6\u00bb\3"+
		"\2\2\2\u00d6\u00be\3\2\2\2\u00d6\u00c1\3\2\2\2\u00d6\u00c4\3\2\2\2\u00d6"+
		"\u00c7\3\2\2\2\u00d6\u00ca\3\2\2\2\u00d6\u00cd\3\2\2\2\u00d6\u00d0\3\2"+
		"\2\2\u00d6\u00d3\3\2\2\2\u00d7\u00da\3\2\2\2\u00d8\u00d6\3\2\2\2\u00d8"+
		"\u00d9\3\2\2\2\u00d9\37\3\2\2\2\u00da\u00d8\3\2\2\2\u00db\u00dc\b\21\1"+
		"\2\u00dc\u00dd\5$\23\2\u00dd\u00ee\3\2\2\2\u00de\u00df\f\6\2\2\u00df\u00e0"+
		"\7\24\2\2\u00e0\u00ed\7\62\2\2\u00e1\u00e2\f\5\2\2\u00e2\u00e3\7\25\2"+
		"\2\u00e3\u00e4\5\36\20\2\u00e4\u00e5\7\34\2\2\u00e5\u00ed\3\2\2\2\u00e6"+
		"\u00e7\f\4\2\2\u00e7\u00e9\7\21\2\2\u00e8\u00ea\5\34\17\2\u00e9\u00e8"+
		"\3\2\2\2\u00e9\u00ea\3\2\2\2\u00ea\u00eb\3\2\2\2\u00eb\u00ed\7 \2\2\u00ec"+
		"\u00de\3\2\2\2\u00ec\u00e1\3\2\2\2\u00ec\u00e6\3\2\2\2\u00ed\u00f0\3\2"+
		"\2\2\u00ee\u00ec\3\2\2\2\u00ee\u00ef\3\2\2\2\u00ef!\3\2\2\2\u00f0\u00ee"+
		"\3\2\2\2\u00f1\u00f2\5 \21\2\u00f2\u00f4\7\21\2\2\u00f3\u00f5\5\34\17"+
		"\2\u00f4\u00f3\3\2\2\2\u00f4\u00f5\3\2\2\2\u00f5\u00f6\3\2\2\2\u00f6\u00f7"+
		"\7 \2\2\u00f7#\3\2\2\2\u00f8\u0105\7\62\2\2\u00f9\u0105\7%\2\2\u00fa\u0105"+
		"\7\64\2\2\u00fb\u0105\7\65\2\2\u00fc\u0105\7\66\2\2\u00fd\u0105\7\63\2"+
		"\2\u00fe\u0105\7+\2\2\u00ff\u0105\7,\2\2\u0100\u0101\7\21\2\2\u0101\u0102"+
		"\5\36\20\2\u0102\u0103\7 \2\2\u0103\u0105\3\2\2\2\u0104\u00f8\3\2\2\2"+
		"\u0104\u00f9\3\2\2\2\u0104\u00fa\3\2\2\2\u0104\u00fb\3\2\2\2\u0104\u00fc"+
		"\3\2\2\2\u0104\u00fd\3\2\2\2\u0104\u00fe\3\2\2\2\u0104\u00ff\3\2\2\2\u0104"+
		"\u0100\3\2\2\2\u0105%\3\2\2\2\u0106\u0109\5(\25\2\u0107\u0109\7\62\2\2"+
		"\u0108\u0106\3\2\2\2\u0108\u0107\3\2\2\2\u0109\'\3\2\2\2\u010a\u010b\t"+
		"\t\2\2\u010b)\3\2\2\2\32\619>BKPZdr|\u0087\u008f\u0098\u009c\u00a3\u00b6"+
		"\u00d6\u00d8\u00e9\u00ec\u00ee\u00f4\u0104\u0108";
